...
export default async function Home() {
  ...
  return (
    <div className="landing-canvas text-slate-900 antialiased">
      <header className="glass-header fixed left-0 right-0 top-0 z-50 border-b border-white/40">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-12">
          <div className="flex items-center gap-2">
            <div className="flex size-10 items-center justify-center rounded-lg bg-cream-beige shadow-sm">
              <Image src="/logo.png" alt={tLanding("logoAlt")} width={46} height={46} />
            </div>
            <h1 className="display-type text-2xl font-bold text-forest-green">Nutra</h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="rounded-xl bg-primary px-5 py-2.5 text-sm font-semibold text-white shadow-sm shadow-primary/35 transition-all hover:-translate-y-0.5 hover:bg-primary/90">
              {tNav("downloadNow")}
            </button>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden pb-20 pt-40 lg:pb-24 lg:pt-44">
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2 lg:items-center lg:px-12">
          <div>
            ...
            <h2 className="display-type mb-8 text-5xl font-extrabold leading-[1.02] text-forest-green lg:text-7xl">
          ...
          <div className="relative">
            ...
            <div className="soft-card absolute -bottom-6 -left-4 hidden rounded-2xl bg-white px-5 py-3 sm:block">
              <p className="text-xs font-semibold uppercase tracking-[0.14em] text-forest-green/70">
                {tLanding("hero.goalProgressLabel")}
              </p>
              <p className="display-type text-2xl font-bold text-forest-green">+28%</p>
            </div>
          </div>
        </div>
      </section>
